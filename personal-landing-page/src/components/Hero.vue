    ...
    <v-banner>
        <v-container class="py-12">
            ...
            <v-row class="py-4">
                <v-col>
                    <v-fade-transition>
                        <v-btn v-show="isGreetActive" :disabled="isDisabled" prepend-icon="mdi-briefcase-outline"
                            variant="outlined" @click.stop="showWork">Check My
                            Work</v-btn>
                    </v-fade-transition>
                </v-col>
            </v-row>
